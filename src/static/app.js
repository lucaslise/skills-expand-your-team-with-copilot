document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateDarkModeButton(isDarkMode) {
    if (!darkModeIcon || !darkModeText) return;
  ...
  function renderActivityCard(name, details) {
    ...
    const shareLinkedInBtn = activityCard.querySelector(".share-linkedin");
    const shareEmailBtn = activityCard.querySelector(".share-email");

    shareTwitterBtn.addEventListener("click", () => shareActivity(name, details, "twitter"));
    shareFacebookBtn.addEventListener("click", () => shareActivity(name, details, "facebook"));
    shareLinkedInBtn.addEventListener("click", () => shareActivity(name, details, "linkedin"));
    shareEmailBtn.addEventListener("click", () => shareActivity(name, details, "email"));
